...
export const questions = [
	{
		id: 1,
		difficulty: 'Fácil',
		question: '¿Cual es la suma de 12 + 15?',
	...
	},
	{
		id: 2,
		difficulty: 'Fácil',
		question: '¿Para que nos sirve el signo +?        ',
		category: matematicas,
		correct_answer: 'Para Sumar',
		incorrect_answers: [
			'Para restar',
			'Para multiplicar',
			'Para dividir',
	...
	},
	{
		id: 3,
		difficulty: 'Fácil',
		question: '¿cual es el resultado de la siguiente operación: 48 - 40?',
		category: matematicas,
		correct_answer: '8',
		incorrect_answers: ['10', '6', '4'],
	},
	{
		id: 4,
		difficulty: 'Facil',
		question:
			"¿Para que nos sirve el signo -'?",
		category: matematicas,
		correct_answer: 'Para restar',
		incorrect_answers: ['Para sumar', 'Para multiplicar', 'Para dividir'],
	},
	{
		id: 5,
		difficulty: 'Facil',
		question:
			'¿Que signo le falta a la siguiete operación: 10()20 = 30?',
		category: matematicas,
		correct_answer: '+',
		incorrect_answers: ['-', 'x', '/'],
	},
